...
class Stats(object):
    ...
    def __init__(self, num_failures=0, num_unreachable=0, failures=None, unreachable=None, no_hosts_remaining=False):
...
class CallbackModule(CallbackBase):
    ...
    def v2_playbook_on_stats(self, ansible_stats):
        ...
        stats = Stats(no_hosts_remaining=self.no_hosts_remaining)
        for h in hosts:
